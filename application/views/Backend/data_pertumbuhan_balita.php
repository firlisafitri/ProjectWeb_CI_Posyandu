      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
              <form method="POST" action="<?php echo base_url().'index.php/Backend/data_pertumbuhan_balita_aksi' ?>" enctype="multipart/form-data">
                ...
                <table class="w-full whitespace-no-wrap">
                  ...
                  >
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3">
                        <input type="hidden" name="id_balita" class="form-control"readonly="readonly" value="<?php echo $balita->id_balita ?>">

                        <input type="checkbox" name="id_pertumbuhan_balita[]" value="<?php echo $pertumbuhan_balita->id_pertumbuhan_balita ?>">
                      </td>
                    </tr>
                  <?php } ?>
                    ...
                    <center>
                        <div class="form-group mt-4 mb-0">
                            <input type="submit" name="proses" class="btn btn-primary" value="Simpan Data Pertumbuhan">
