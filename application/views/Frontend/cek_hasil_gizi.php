...
<head>
  ...
  <meta property="og:type" content="article" />
    ...
    <!-- Website Title -->
    <title>Pertumbuhan - Posyandu Anggrek Bulan</title>
...
<body data-spy="scroll" data-target=".fixed-top">
  ...
  <div class="spinner-wrapper">
    ...
    <div class="container grid px-6 mx-auto">
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                <form <?php foreach ($tbl_balita as $balita) { ?>
                method="POST" action="<?php echo base_url().'index.php/Frontend/cetak_hasil_pertumbuhan/'.$balita->id_balita.'' ?>" target="_Blank"
            <?php } ?>
                >
