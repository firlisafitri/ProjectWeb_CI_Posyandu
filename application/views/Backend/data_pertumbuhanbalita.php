        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul>
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?php echo base_url().'index.php/Backend/forms' ?>"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            ...
            <div> 
              <a href="<?php echo base_url().'index.php/Backend/data_pertumbuhanbalita_input' ?>" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
              > 
              Tambah Data
              </a>
            </div>&nbsp;&nbsp;
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  ...
                  >
                    <?php $no = 1; foreach ($tbl_pertumbuhan_balita as $pertumbuhan_balita) { ?>
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3 text-sm">
                        <?php echo $pertumbuhan_balita->tgl_cek ?>
                      </td>
                      <td class="px-4 py-3 text-sm">
                        <?php echo $pertumbuhan_balita->usia ?> bulan
                      </td>
                      <td class="px-4 py-3 text-sm">
                        <?php echo $pertumbuhan_balita->berat_badan ?> kg
                      </td>
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                          <a
                            href="<?php echo base_url().'index.php/Backend/data_pertumbuhan_balita_edit/'.$pertumbuhan_balita->id_pertumbuhan_balita.'' ?>" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                            aria-label="Edit"
                          >
                            <svg
                              class="w-5 h-5"
                          ...
                          <a
                            href="<?php echo base_url().'index.php/Backend/data_pertumbuhan_balita_delete/'.$pertumbuhan_balita->id_pertumbuhan_balita.'' ?>" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini ?')"
                            aria-label="Delete"
                          >
                            <svg
                              class="w-5 h-5"
