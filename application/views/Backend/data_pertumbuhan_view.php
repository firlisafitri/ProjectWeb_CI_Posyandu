            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
              ...
              <?php } ?>
                ...
                <div class="text-right"> 
                  <a href="<?php echo base_url().'index.php/Backend/cek_hasil_gizi1/'.$balita->id_balita.'' ?>" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
                  >
