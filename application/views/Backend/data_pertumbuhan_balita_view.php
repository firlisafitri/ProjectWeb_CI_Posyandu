    ...
    >
      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
              ...
              <?php } ?>
                ...
                <div class="text-right"> 
                  <a href="<?php echo base_url().'index.php/Backend/cek_hasil_gizi/'.$balita->id_balita.'' ?>" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
                  >
                  Cek Hasil Status Gizi
                  </a>&nbsp;
                </div>&nbsp;&nbsp;
            </div>&nbsp;&nbsp;
          ...
          <div> 
              <a href="<?php echo base_url().'index.php/Backend/data_pertumbuhan_input' ?>" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
              > 
              Tambah Data
              </a>
          </div>
          <div class="text-right"> 
              <a href="<?php echo base_url().'index.php/Backend/grafik/'.$balita->id_balita.'' ?>" class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
              > 
              Grafik Pertumbuhan
              </a>
          </div>&nbsp;&nbsp;
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                          <a href="<?php echo base_url().'index.php/Backend/data_testing_view/'.$pertumbuhan->id_pertumbuhan.'' ?>" class="px-3 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
                          >
                          Metode KNN
                          </a>
                          <a
