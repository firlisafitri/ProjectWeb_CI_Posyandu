      ...
      <div class="flex flex-col flex-1">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            >
              <form method="POST" action="<?php echo base_url().'index.php/Backend/data_balita_input_aksi' ?>" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="id_ortu" class="form-control">
                                    ...
                                    ?>
                                    <option value="<?php echo $ortu->id_ortu ?>"><?php echo $ortu->nm_ibu ?></option>    
                    ...
                    <div class="form-row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="nm_balita" class="form-control" placeholder="Masukkan Nama Balita">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="bb_lahir" step='any' class="form-control" placeholder="0,0 kg">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Panjang Badan Lahir</label>
                                <input type="number" name="pb_lahir" step='any' class="form-control" placeholder="00 cm">
                            </div>
                        </div>
                    </div>
